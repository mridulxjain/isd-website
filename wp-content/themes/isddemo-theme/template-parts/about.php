...
$intro_text    = function_exists('get_field') ? get_field('hp_about_text')    : 'Interior Shapes Design is a New Delhi-based design studio creating luxury interiors, exteriors and turnkey spaces for discerning clients across India and internationally.';
